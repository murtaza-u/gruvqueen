local function init(c, config)
    local base = {
        ...
        ErrorMsg = {fg = c.red, style = config.disable_bold and "underline" or "bold,underline", },
        WarningMsg = {fg = c.yellow, style = config.disable_bold and "NONE" or "bold", },
        ModeMsg = {fg = c.fg0, style = config.disable_bold and "NONE" or "bold", },
        MoreMsg = {fg = c.yellow, style = config.disable_bold and "NONE" or "bold", },
