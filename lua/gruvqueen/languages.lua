local languages = {
    ...
    LspDiagnosticsVirtualTextWarning = {fg = C.red, bg = C.none, },
    LspDiagnosticsVirtualTextInformation = {fg = C.red, bg = C.none, },
    LspDiagnosticsVirtualTextHint = {fg = C.red, bg = C.none, },
